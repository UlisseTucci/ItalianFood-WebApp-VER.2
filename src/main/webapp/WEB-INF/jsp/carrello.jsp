...
<body class="carrello-back" onload=caricaCarrello() style="background-color: white">
<link rel="stylesheet" href="css/carrello.css" type="text/css"/>
<link rel="stylesheet" href="css/style.css" type="text/css"/>


<section class="carrello-back" style="background-color:#FF0000;">
                    ...
                    <div class="card-body p-0">
                        <div class="row g-0">
                            <div class="col-lg-8">
                                ...
                                <button onclick="svuotaCarrello()" style="float: right" type="button" class="btn btn-outline-danger">Svuota carrello</button>
                                <div class="p-5">
