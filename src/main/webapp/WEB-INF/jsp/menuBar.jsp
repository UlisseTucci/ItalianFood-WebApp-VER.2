  ...
  <div class="container-fluid">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" >
        ...
        <c:if test="${utente.admin==true}"> <a class="dropdown-item" href="/segnalazioni">Segnalazioni</a> </c:if>
        ...
        <c:if test="${utente.nome==null}"> <a class="dropdown-item" href="/login">Ricette preferite</a> </c:if>
        <c:if test="${utente.nome!=null}"> <a class="dropdown-item" href="/preferiti">Ricette preferite</a> </c:if>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <c:if test="${utente.admin==true}"> <a class="nav-link" href="/segnalazioni">Segnalazioni</a> </c:if>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <c:if test="${utente.nome==null}"> <a class="nav-link" href="/login">Ricette Preferite</a> </c:if>
          <c:if test="${utente.nome!=null}"> <a class="nav-link" href="/preferiti">Ricette Preferite</a> </c:if>
        </li>
        <li class="nav-item">
