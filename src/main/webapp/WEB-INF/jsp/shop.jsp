        ...
        <header class=" shop">
            <div class="container px-4 px-lg-5 my-5" >
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder" style="margin-top: 100px">Negozio ingredienti</h1>
                    <p class="display- fw-bolder" style="color: black">Compra gli ingredienti per comporre le tue ricette!</p>
                </div>
            </div>
        </header>
        <!-- Section-->
