...
<div class="wizard">
    <nav class="list-group list-group-flush">
        ...
        <a class="list-group-item" id="LeTueRicette" href="/leTueRicette"><i class="fe-icon-user text-muted"></i>Le tue ricette</a>
        <a class="list-group-item" id="Preferiti" href="/preferiti"><i class="fe-icon-user text-muted"></i>Preferiti</a>
