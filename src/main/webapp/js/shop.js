...
function creaProdotto(prodotto)
{
    ...
    div.innerHTML="<div class=\"col mb-5\">\n" +
        ...
        "                            <div class=\"badge bg-dark text-white position-absolute\" style='top: 0.5rem; right: 0.5re'>Scade: "+prodotto.scadenza+"</div>\n"+
        "                            <!-- Product image-->\n" +
        "                            <img class=\"card-img-top\" src='"+prodotto.immagine+"' alt=\"...\" />\n" +
        "                            <!-- Product details-->\n" +
